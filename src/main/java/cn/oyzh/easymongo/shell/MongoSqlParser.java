 ...
 * @since 2024/2/26
 */
public class MongoSqlParser extends DBSqlParser {

    public MongoSqlParser(String sqlContent, DBDialect dialect) {
        super(sqlContent, dialect);
    }

    @Override
    public String removeComment() {
        return MongoUtil.removeComment(this.sqlContent);
    }
